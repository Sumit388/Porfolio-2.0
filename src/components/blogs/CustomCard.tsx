...
export default function CustomCard({Image}:{Image:string}) {
  return (
   <div className="md:w-[260px] w-[86vw] h-[200px]  shadow-2xl rounded-2xl p-2 relative overflow-hidden elevatedEffect">
    <img src={Image} alt="" className="absolute top-0  md:w-[260px] w-[86vw] h-[200px] left-0 object-cover"/>
    <div className="absolute top-0  md:w-[260px] w-[86vw] h-[200px] bg-[#00000071] left-0 object-cover"/>
